...
def _quality_id(field: object) -> str | None:
    ...
    mapping = ((("红色", "神话", "mythic", "red"), "mythic_red"), (("金色", "传奇", "传说", "legendary", "gold"), "legendary_gold"), (("紫色", "史诗", "epic", "purple"), "epic_purple"), (("蓝色", "稀有", "rare", "blue"), "rare_blue"))
...
class EquipmentDatabase:
    ...
    def upsert_recognized_equipment(self, record: dict, *, source_screenshot: str | Path | None = None) -> dict:
        ...
        quality_id = _quality_id(stored_record.get("quality"))
